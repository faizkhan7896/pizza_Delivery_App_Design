            ...
            <View style={styles.container}>
                ...
                <View style={styles.header}>
                    <View style={{
                        ...
                        <Text style={styles.text_header}>Enter Pin</Text>
                ...
                <Animatable.View style={styles.footer}
                    ...
                    <Image style={{
                        height: 350, width: "100%", resizeMode: "contain", marginTop: -15
                    }}
                    ...
                    <View>
                        <TextInput
                            ...
                            secureTextEntry />
                        <Text style={{ fontSize: 18, color: "gray", alignSelf: "center", marginTop: 10 }}>Enter the Pin Code sent your </Text>
                        <Text style={{ fontSize: 18, color: "gray", alignSelf: "center" }}>phone to Canfirm Payment</Text>

                    </View>
                    <Image style={{
                        height: 200, width: "23%", resizeMode: "contain", marginLeft: 20
                    }}
